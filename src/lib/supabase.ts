...
export const supabase = createClient(
  ...
  'sb_publishable_1Qp5cKIVWk-GUjNieLMxfA_sgWn4Tek'
)
...
create table benutzer (
  ...
  initialen text default '',
  av_farbe text default '#0284c7'
);
...
create table artikel (
  ...
  lagerplatz_code text default '',
  lagerplatz_bezeichnung text default '',
  bemerkung text default '',
  hinweise text[] default '{}',
  emoji text default '📦',
  foto_url text,
  erfasst_am timestamptz default now(),
  erfasst_von text default '',
...
-- RLS: simple open policies (tighten after adding auth)
